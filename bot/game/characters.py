...
DUELIST_VIRTUOSO_FLOOR = 50
DUELIST_VIRTUOSO_ZONE_CHARGES = 3
DUELIST_ZONE_TURNS = 2
DUELIST_PARRY_REDUCTION = 0.30
DUELIST_PARRY_REDUCTION_BOSS = 0.50
DUELIST_PARRY_REDUCTION_VIRTUOSO = 0.60
...
CHARACTERS = {
    ...
    RUNE_GUARD_ID: {
        ...
        "description": [
            ...
            "Поднять щиты: 1 ОД, броня +2 до конца хода врагов (1 раз за ход).",
            "Отбросить щиты: 1 ОД, броня 0, каждый 2-й удар 100% точности (1 раз за ход).",
            "Поднять щиты и отбросить щиты нельзя использовать вместе в одном ходу.",
            "Каменный Ответ: получив удар >25% HP, следующий удар игнорирует 100% брони.",
            "Стойкая Воля: на полном HP в начале хода +1 ОД (не выше максимума).",
    ...
    DUELIST_ID: {
        ...
        "description": [
            ...
            "Парирование: первый успешный удар врага в фазу снижает урон на 30% (на боссах 50%) и контратакует на 50% предотвращенного урона.",
            ...
            "Виртуоз (50+ этаж): дуэльная зона 3 заряда, парирование снижает урон на 60%.",
            "На последнем издыхании: при HP ≤ 1/3 точность 100%.",
        ],
    },
}
