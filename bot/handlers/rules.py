...
def _format_enemies() -> str:
    lines = [
        ...
        "Элиты (50+): <b>Проклятый Клинок тени</b>, <b>Проклятая Каменная шкура</b>, <b>Проклятый Слепой охотник</b>.",
        "",
    ]
    for item in ENEMIES:
    ...
    lines.append("- Павший герой частично игнорирует уклонение и гарантированно попадает каждый 2-й удар.")
    lines.append("- Некромант и Дочь некроманта не промахиваются.")
...
def _format_magic() -> str:
    lines = [
        ...
        "Решимость (полное здоровье) усиливает урон магии.",
    ]
