...
- Боссы: Некромант (10 этаж), Павший герой (каждые 10 этажей после 10, кроме кратных 50), Дочь некроманта (каждые 50 этажей). Все боссы не промахиваются.
...
- Испытания руин обновляются каждые 30 минут (UTC): 3 задачи на один забег (минимум одна боевая и одна по прогрессу), каждая даёт +10 XP.
...
- Если `ap_max` уже выше лимита, он временно режется до максимума.
...
- XP за забег = достигнутый этаж + сокровища (по 5 XP за каждое) + испытания руин (по 10 XP).
