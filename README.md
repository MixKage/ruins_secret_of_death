...
- Награда за Павшего героя — сильное зелье; за Дочь некроманта — пополнение зелий до половины, свиток молнии и +10 XP.
...
boss_armor *= 2.0
```
Награда: пополнение зелий до половины, свиток молнии и +10 XP.
