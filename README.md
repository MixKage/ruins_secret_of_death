...
- Награды текущего сезона, история сезонных наград (стекается) и вечные награды.
...
- Опыт начисляется за завершенные забеги и за полученные награды.

### Опыт и уровни
- XP за забег = достигнутый этаж + сокровища (по 5 XP за каждое).
