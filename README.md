...
- После 50-го уровня появляются элиты: «Проклятый Клинок тени» (первый удар игрока мимо), «Проклятая Каменная шкура» (броня растет), «Проклятый Слепой охотник» (не промахивается).
...
- Решимость (полное здоровье) усиливает урон магии на 20%.
